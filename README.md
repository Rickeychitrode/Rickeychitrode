...
We have video tutorials for [Windows](https://youtu.be/JlMAlVhIxeI),  and [Android](https://youtu.be/k8QDhXwOQeM) users. Please watch them if you are unsure about the installation process.
...
- [Announcement Channel (`jiotv_go`)](https://t.me/All_new_apps)
- [Support Group (`jiotv_go_chat`)](https://t.me/Discussion_movie_web_seris)
